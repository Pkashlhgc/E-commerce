...
<html lang="en">
	<head>
		...
		<meta name="author" content="Udityanshu dubey">
		
		<title> Seller Login | SuperShop</title>
		...
		<div class="container">
			<form class="form-signin" method="post" action="">
				...
				<div class="login-wrap">
					...
					<button name="try_login" class="btn btn-lg btn-login btn-block" type="submit">LOG IN
						<i class="fa fa-check"></i>
					</button>
					
					<a href="/scrappoint"><button name="goback" class="btn btn-lg btn-login btn-block" type="button">BUY</button></a>
					<h5 class="text-center">     | Login with your buying account |</h5>
					<?php
					$url="http://localhost/scrappoint/admin/";
					$bites=parse_url($url);
					$newLocation=$bites['scheme'] .'://' . $bites['host'] . '/'. 'scrappoint'. '/' . 'register-account.php'
					?>
					<div class="registration"> Not a member yet? <a href="<?php echo $newLocation ?>"> Signup </a></div>
				</div>
			</form>
		</div>	
