					...
					<div class="panel">
						<div class="panel-body">
							...
							<div class="text-center" style="padding-bottom: 10px;">
								...
								<h5 class="designation"><?php if($_SESSION['SMC_login_admin_type']=="Root Admin"){
									?>
									Admin
									<?php
								}
						...
						<div class="panel-body">
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href=""> 
									<i class="fa fa-envelope"></i> &nbsp;<?php echo $_SESSION['SMC_login_admin_email']?>
								</a>
							</div>
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="skype:live:.cid.5ed7daebee5e7820"> 
									<i class="fa fa-skype"></i> &nbsp; <?php echo $_SESSION['SMC_login_admin_name'] ?>
								</a>
							</div>
						</div>
					</div>
						...
						<div class="carousel slide auto panel-body" id="c-slide">
							...
							<div class="carousel-inner">
								<div class="item text-center active">
									<h3> SCRAP POINT | ONLINE BUYING/SELLING STORE </h3>
									<p> frontEnd Development </p>
									<p class="text-muted">
										Scarppoint.com is a eCommerce application for buying and selling old products
									</p>
								</div>
								<div class="item text-center">
									...
									<p> frontEnd Development </p>
									<p class="text-muted">
										and also easy to use, so that it will match user expectation and friendly
									</p>
								</div>
								<div class="item text-center">
									<h3> SCRAP POINT | ONLINE BUYING/SELLING STORE </h3>
