	...
	<div class="row">
		<div class="col-lg-12">
            ...
            <li> <a href="dashboard.php"> <i class="fa fa-home"></i> Home </a> </li>
				<li class="active"> Create <?php echo $show ;?> </li>
			</ul>
			<section class="panel">
				<header class="panel-heading">
				   
				 New <?php echo $show ;?> Registration Form
					...
					<div class="form">
						<form class="cmxform form-horizontal" method="post" action="" enctype="multipart/form-data">
							<div class="form-group ">
								<label for="AdminName" class="control-label col-lg-2"><?php echo $show ;?> Name </label>
								<div class="col-lg-7">
									<input class=" form-control" name="admin_name" type="text" required />
								</div>
							</div>
							<div class="form-group ">
								<label for="AdminEmail" class="control-label col-lg-2"> <?php echo $show ;?> Email </label>
								<div class="col-lg-7">
									<input class="form-control "name="admin_email" type="email" autocomplete="none" required />
								</div>
							</div>
							<div class="form-group ">
								<label for="AdminPassword" class="control-label col-lg-2"> <?php echo $show ;?> Password </label>
								<div class="col-lg-7">
									<input class="form-control" name="admin_password" type="password" autocomplete="none" required />
								</div>
							</div>
							<div class="form-group ">
								<label for="AdminType" class="control-label col-lg-2" > <?php echo $show ;?> Type </label>
								<div class="col-lg-7">
									<?php
									if(isset($_SESSION['SMC_login_admin_type'])){
										?>
									...
									<?php
										...
										?>
										<select name="admin_type" class="form-control">
										<option value="Content Manager"> Seller </option>
										</select>
											<?php
									}
									?>
							...
							?>
							<div class="form-group">
								<label for="AdminImage" class="control-label col-md-2"> <?php echo $show ;?> Image </label>
							...
							<div class="form-group last">
								<label for="AdminImagePreview" class="control-label col-md-2"> <?php echo $show ;?>sImage Preview </label>
								<div class="col-lg-7">
									<div class="fileupload fileupload-new" data-provides="fileupload">
