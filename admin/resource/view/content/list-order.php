...
$columnName["7"] = "shippings.shipcstmr_country";
$columnName["8"] = "orders.id";
$columnName["9"] = "orders.transaction_status";
$columnName["10"] = "orders.order_item_status";
$columnName["11"] = "customers.customer_email";
$columnName["12"] = "order_items.product_id";
$columnName["13"] = "products.Posted_By";
$tableName["MAIN"] = "shippings";
$joinType = "INNER";
$tableName["1"] = "orders";
$tableName["2"] = "customers";
$tableName["3"]="order_items";
$tableName["4"]="products";
$onCondition["1"] = ["shippings.order_id", "orders.id"];
$onCondition["2"] = ["customers.id", "shippings.customer_id"];
$onCondition["3"]=["orders.id","order_items.order_id"];
$onCondition["4"]=["order_items.product_id","products.id"];
if($_SESSION['SMC_login_admin_type']=="Root Admin"){
	$whereValue=null;
}
else{
	$whereValue["products.Posted_By"]=$_SESSION['SMC_login_admin_name'];
}

$ordersList = $eloquent->selectJoinData($columnName, $tableName, $joinType, $onCondition,$whereValue);
## ===*=== [F]ETCH ORDERS DATA ===*=== ##
?>
