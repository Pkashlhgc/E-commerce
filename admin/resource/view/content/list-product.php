...
$columnName["10"]= "products.Added_By";
...
if ($_SESSION['SMC_login_admin_type']=="Content Manager"){

	$whereValue["Posted_By"] =$_SESSION['SMC_login_admin_name'];
}
else{
	$whereValue=null;
}
$productList = $eloquent->selectJoinData($columnName, $tableName, $joinType, $onCondition,$whereValue);
## ===*=== [F]ETCH PRODUCT DATA ===*=== ##
?>
