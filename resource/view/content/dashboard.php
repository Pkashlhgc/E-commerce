...
if(isset($_REQUEST['did']))
{
	...
	$columnName=["order_id"];
	$whereValue["product_id"] = $_REQUEST['did'];
	$getOrderData = $eloquent->selectData($columnName,$tableName,@$whereValue);
	...
	$tableName = $whereValue = null;
	$tableName = "invoices";
	$whereValue["order_id"] =$getOrderData[0]['order_id'];
	$deletecustomerData = $eloquent->deleteData($tableName, $whereValue);
	...
	$tableName = $whereValue = null;
	$tableName = "orders";
	$whereValue["id"] =$getOrderData[0]['order_id'];
	$deletecustomerData = $eloquent->deleteData($tableName, $whereValue);
			...
			if(isset( $_SESSION['SSCF_login_id'])){?>
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body">
							<a href="order_details.php"><button type="button" name="order_details" class="btn btn-sm btn-outline-info">Click here to view</button></a>
