...
if(isset($_POST['userRegistration']))
{
	...
	!empty($_POST['acc_address']))
	{
		...
		$tableName2="admins";
		$columnValue1["admin_name"]=$_POST['acc_fname'] . " " . $_POST['acc_lname'];
		$columnValue1["admin_email"]=$_POST['acc_email'];
		$columnValue1["admin_password"] = sha1($_POST['acc_password']);
		$columnValue1["admin_status"] ='Active';
		$columnValue1["admin_type"] ='Content Manager';

		$registerUser2 = $eloquent->insertData($tableName2, $columnValue1);
					...
					if(isset($_POST['userRegistration']))
					{
						if(@$registerUser > 0)
						{
							echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
										Thank you for registering with <b>SCRAPPOINT.COM</b> Please  
