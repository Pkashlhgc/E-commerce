						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								<div class="widget">
									...
									<p>Scrap Point is a place where you can get all old items  and Sell too</p>
									<p> 
							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address: </span>Prayagraj</li>
										<li><span class="contact-info-label">Phone: </span>Toll Free <a href="tel:">91 6392912409</a></li>
										<li><span class="contact-info-label">Email: </span> <a href="tprashant112@gmail.com">tprashant112@gmail.com</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved & copy; <?= date('Y') ?> | Developed By 
							<a href="https://www.linkedin.com/in/prashant-tiwari-9370a9226" target="_blank">Prashant Tiwari</a>
						</p>
