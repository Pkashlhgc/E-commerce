...
<html lang="en">
	<head>
		...
		<title> ScrapPoint | <?php echo $pageTitle ?> </title>
			...
			<header class="header" id="header">
				<div class="header-top">
					<div class="container">
						<div class="header-left header-dropdowns">
							...
							<div class="header-dropdown">
								<a href="#"><img src="public/assets/images/favicon/bd.png" alt="India flag">INDIA</a>
								<div class="header-menu">
									<ul>
				...
				<div class="header-middle">
					<div class="container">
						...
						<div class="header-left">
						<a href="index.php"><button type="button" class="btn btn-primary btn-sm mx-3">BUY</button></a>
						<a href="/scrappoint/admin/"><button type="button" class="btn btn-secondary btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
						...
						<div class="header-right">
							...
							<div class="header-contact"><span>Call us now</span>
								<a href="tel:#"><strong>+91 6392912409</strong></a>
							</div>
